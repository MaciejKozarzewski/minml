...
nvcc -ccbin cl -m64 -arch=all -std=c++17 -O3 -DUSE_CUDA -DIN_THE_DLL -DNDEBUG -I"include/" -default-stream per-thread -DUSE_CUDA -DBUILDING_DLL -shared -o "build/cudaml.dll" "src/backend/cuda/cuda_context.cpp" "src/backend/cuda/cuda_event.cpp" "src/backend/cuda/cuda_memory.cu" "src/backend/cuda/cuda_properties.cpp" "src/backend/cuda/cudnn_math.cpp" "src/backend/cuda/gemms.cpp" "src/backend/cuda/utils.cpp" "src/backend/cuda/kernels/activations.cu" "src/backend/cuda/kernels/attention.cu" "src/backend/cuda/kernels/batchnorm.cu" "src/backend/cuda/kernels/conversion.cu" "src/backend/cuda/kernels/depthwise_conv.cu" "src/backend/cuda/kernels/global_pooling.cu" "src/backend/cuda/kernels/layernorm.cu" "src/backend/cuda/kernels/pooling.cu" "src/backend/cuda/kernels/quantized.cu" "src/backend/cuda/kernels/rmsnorm.cu" "src/backend/cuda/kernels/softmax.cu" "src/backend/cuda/kernels/tensor_op.cu" "src/backend/cuda/kernels/training.cu" "src/backend/cuda/kernels/winograd_nonfused.cu" cudart.lib cublas.lib
